class GameInfo:
    def __init__(self, match_id):
        ...
        self.corners_home = 0
        self.corners_away = 0
        self.shots_inside_the_area_home = 0
        self.shots_inside_the_area_away = 0
        self.shots_outside_the_area_home = 0
        self.shots_outside_the_area_away = 0
        self.shots_on_the_post_home = 0
        self.shots_on_the_post_away = 0
        ...
        self.throws_home = 0
        self.throws_away = 0
        self.passes_home = 0.0
        self.passes_away = 0.0
        self.passes_in_the_last_third_home = 0.0
        self.passes_in_the_last_third_away = 0.0
        self.crosses_home = 0.0
        self.crosses_away = 0.0
        self.effective_tackles_home = 0.0
        self.effective_tackles_away = 0.0
        self.tackles_home = 0
        self.tackles_away = 0
